...
const RegisterRoomChecklist: React.FC = () => {
    ...
    const isLocationActived = useMemo(() => {
        ...
        if (!isBuildingTypeActived || !latitude || !longitude || !country || !city || !district || !streetAddress || !postcode) {
            return false;
        } else {
            return true;
        }
    ...
    // 편의 시설이 활성화됐는지
    const isAmetitiesActived = useMemo(() => {
