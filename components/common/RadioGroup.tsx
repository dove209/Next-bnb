...
import WaningIcon from '../../public/static/svg/common/warning.svg';
...
const RadioGroup: React.FC<IProps> = ({ label, value, options = [], onChange, isValid, errorMessage = '옵션을 선택하세요.' }) => {
    ...
    return (
        <Container isValid={!!isValid} validateMode={validateMode}>
            ...
            {validateMode && !isValid && (
                <div className='radio-group-warnig'>
                    <WaningIcon />
                    <p>{errorMessage}</p>
                </div>
            )}
